...
public sealed class DiscoveryRefreshBackgroundService : BackgroundService
{
    ...
    private void LogDiscoveryChanges(EtDiscovery.Runtime.Models.EasyTierObservationSnapshot observation, EtDiscovery.Core.Models.DiscoverySnapshot snapshot)
    {
