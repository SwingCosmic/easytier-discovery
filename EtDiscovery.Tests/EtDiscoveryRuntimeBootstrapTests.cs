...
[TestFixture]
public class EtDiscoveryRuntimeBootstrapTests
{
    [Test]
    public void LoadOptionsFromSplitConfigurationAndRolesFromCommandLine()
    {
        ...
        var options = EtDiscoveryRuntimeBootstrap.LoadOptions(builder, ["--roles", "registry,worker"]);
    ...
    public void EmptyCliPathFallsBackToSiblingBinary()
    {
        ...
        var options = EtDiscoveryRuntimeBootstrap.LoadOptions(builder, ["--roles", "registry"]);
    ...
    public void MissingRolesOnCommandLineThrows()
    {
        ...
        Assert.That(() => EtDiscoveryRuntimeBootstrap.LoadOptions(builder, []),
    ...
    public void RolesCanBeProvidedViaEnvironmentAlias()
    {
        ...
        try
        {
            ...
            var options = EtDiscoveryRuntimeBootstrap.LoadOptions(builder, []);
    ...
    public void MissingWorkerServicesThrows()
    {
        ...
        Assert.That(() => EtDiscoveryRuntimeBootstrap.LoadOptions(builder, ["--roles", "worker"]),
    ...
    public void RegistryWithoutIpv4OrPeersThrows()
    {
        ...
        Assert.That(() => EtDiscoveryRuntimeBootstrap.LoadOptions(builder, ["--roles", "registry"]),
